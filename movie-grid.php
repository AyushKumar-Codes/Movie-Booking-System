...
if (!empty($search_query)) {
    // If a search query is provided, ignore filters and search by name
    $sql = "SELECT * FROM movies WHERE name LIKE ?";
    $search_term = "%{$search_query}%";

    // Prepare and execute the query
    $stmt = $con->prepare($sql);
    $stmt->bind_param("s", $search_term);  // Bind the search term
    $stmt->execute();
    $result = $stmt->get_result();
} else {
    // If no search query is provided, apply filters
    ...
    if (!empty($selectedLanguages)) {
        ...
        // Combine language filters with AND
        $sql .= " AND (" . implode(" AND ", $languagesQuery) . ")";
    }
    ...
    if (!empty($selectedExperiences)) {
        ...
        // Combine experience filters with AND
        $sql .= " AND (" . implode(" AND ", $experiencesQuery) . ")";
    }
    ...
    if (!empty($selectedGenres)) {
        ...
        // Combine genre filters with AND
        $sql .= " AND (" . implode(" AND ", $genresQuery) . ")";
    }
        ...
        <div class="container">
            <div class="search-tab bg_img" data-background="./assets/images/ticket/ticket-bg01.jpg">
                ...
                <div class="tab-area">
                    ...
                    <div class="tab-item">
                        <center>
                            <h4>No Events Available Now</h4>
                        </center>

                    </div>
                    <div class="tab-item">
                        <center>
                            <h4>No Sports Available Now</h4>
                        </center>
                    ...
                    <form action="movie-grid.php" method="GET">
                        <div class="widget-1 widget-check">
                            ...
                            <div class="widget-1-body">
                                ...
                                <div class="check-area">
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang1" value="Tamil" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('Tamil', $_GET['lang']) ? 'checked' : ''));?>>
                                        <label for="lang1">Tamil</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang2" value="Telegu" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('Telegu', $_GET['lang']) ? 'checked' : ''));?>>
                                        <label for="lang2">Telegu</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang3" value="Hindi" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('Hindi', $_GET['lang']) ? 'checked' : ''));?>>
                                        <label for="lang3">Hindi</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang4" value="English" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('English', $_GET['lang']) ? 'checked' : ''));?>>
                                        <label for="lang4">English</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang5" value="Multiple Language" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('Multiple Language', $_GET['lang']) ? 'checked' : ''));?>>
                                        <label for="lang5">Multiple Language</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang6" value="Gujrati" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('Gujrati', $_GET['lang']) ? 'checked' : ''));?>>
                                        <label for="lang6">Gujrati</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="lang[]" id="lang7" value="Bangla" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['lang']) && in_array('Bangla', $_GET['lang']) ? 'checked' : ''));?>>
                        ...
                        <div class="widget-1 widget-check">
                            <div class="widget-1-body">
                                ...
                                <div class="check-area">
                                    <div class="form-group">
                                        <input type="checkbox" name="mode[]" id="mode1" value="2d"
                                            <?php echo (isset($_POST['search']) ? '' : (isset($_GET['mode']) && in_array('2d', $_GET['mode']) ? 'checked' : ''));?>>
                                        <label for="mode1">2D</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="mode[]" id="mode2" value="3d" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['mode']) && in_array('3d', $_GET['mode']) ? 'checked' : ''));?>>
                        ...
                        <div class="widget-1 widget-check">
                            <div class="widget-1-body">
                                ...
                                <div class="check-area">
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre1" value="Thriller" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Thriller', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre1">Thriller</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre2" value="Horror" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Horror', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre2">Horror</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre3" value="Drama" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Drama', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre3">Drama</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre5" value="Action" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Action', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre5">Action</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre6" value="Comedy" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Comedy', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre6">Comedy</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre7" value="Romantic" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Romantic', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre7">Romantic</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre8" value="Animation" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Animation', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre8">Animation</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre9" value="Sci-Fi" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Sci-Fi', $_GET['genre']) ? 'checked' : '')); ?>>
                                        <label for="genre9">Sci-Fi</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" name="genre[]" id="genre10" value="Adventure" <?php echo (isset($_POST['search']) ? '' : (isset($_GET['genre']) && in_array('Adventure', $_GET['genre']) ? 'checked' : ''));?>>
